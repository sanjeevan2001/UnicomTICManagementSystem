...
namespace UnicomTICManagementSystem.Repositories
{
    internal class Migration
    {
        public static void CreateTables()
        {
            ...
            CREATE TABLE IF NOT EXISTS Lecturers(LecturerID INTEGER PRIMARY KEY AUTOINCREMENT,
                Lecturername TEXT NOT NULL, Address TEXT NOT NULL, PhoneNumber TEXT NOT NULL); 
            ...
            CREATE TABLE IF NOT EXISTS Students(StudentID INTEGER PRIMARY KEY AUTOINCREMENT, Name TEXT NOT NULL,
                CourseID INTEGER NOT NULL,Address TEXT NOT NULL,PhoneNumber TEXT NOT NULL,NIC TEXT NOT NULL, FOREIGN KEY (CourseID) REFERENCES Courses(CourseID));
